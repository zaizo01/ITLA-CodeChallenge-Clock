...
function VistaPreguntas() {
  ...
  const respuestasAleatoria = respuestas.sort(() => Math.random() - 0.5);
                ...
                <div className="p-5 ">
                  <div className="p-5  border-4 border-red-200 border-dashed rounded-lg dark:border-gray-700">
                    ...
                    <div className="text-left ">
                      <form className="container w-full mt-5">

                        {respuestasAleatoria.map((respuesta, index) => (
                          <div className="" key={index}>
                            <label htmlFor={`respuesta${index + 1}`} className="text-white ">
                              <input
                                ...
                                onChange={handleRespuestaSeleccionada}
                              />
                              <span>{respuesta}</span>
                            </label>
                          </div>
