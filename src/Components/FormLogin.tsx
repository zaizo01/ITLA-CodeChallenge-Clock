...
export default function FormLogin() {
    ...
    const handleOnSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        //
        MySwal.informationMessage("Espere, solicitud de inicio de sesión en progreso.")
    ...
    return (
        ...
        >
              <section className="max-w-md md:mt-0 mt-12 w-full md:flex-shrink-0 md:mr-4 mb-4 md:mb-0">
                <div className="max-w-md relative flex flex-col p-2 rounded-md text-black bg-gradient-to-r from-[#F87FFE] to-[#A890E1]">
